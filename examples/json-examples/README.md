...
Example output from `sync.py` v3.85 for a fictional cyclist in a Build phase. Use these to understand the data schema before running your own sync.
...
These examples reflect sync.py v3.85 / Section 11 v11.16. Key fields added since earlier examples:
